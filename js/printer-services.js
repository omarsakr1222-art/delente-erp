 ...
 * بـ Bluetooth Printing و ESC/POS support
 */
...
(function(){
    ...
    console.log('✓ Bluetooth Printer Services loaded');
})();

// Export to window
window.PrinterServices = {
    connectToPrinter: window.connectToPrinter,
    printInvoiceBluetooth: window.printInvoiceBluetooth
};
